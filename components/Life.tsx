  ...
  return (
    <section className="w-3/4 mx-auto my-20">
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
        className="relative w-full h-1 bg-gradient-to-l from-black via-white to-black  mt-40 mb-96 rounded-full"
      >
        ...
        <div className="bg-black flex items-center justify-center  w-10 h-10 rounded-full absolute top-1/2 -translate-y-1/2 -translate-x-1/2 left-[30%] border border-white ">
          <TbSchoolOff className="text-2xl" />
        </div>
        <div className="bg-black flex items-center justify-center  w-10 h-10 rounded-full absolute top-1/2 -translate-y-1/2 -translate-x-1/2 left-[60%] border border-white ">
        ...
        <p className="absolute -top-16 left-[32%] w-32 -translate-x-1/2">
          May 2017
        </p>
        <p className="absolute -top-16 left-[60%] -translate-x-1/2">May 2020</p>
        ...
        <div className="absolute -bottom-[1100%] translate-y-[100%] left-[30%] -translate-x-1/2 w-96 p-5 border border-white rounded-lg">
          <div className="absolute left-1/2 -translate-x-1/2 top-0 -translate-y-full w-0 h-0 border-l-[20px] border-l-transparent border-b-[20px] border-b-white border-r-[20px] border-r-transparent"></div>
          <p>
            During my high school years, I made the decision to not complete my
            education as I felt that traditional schooling was not the best fit
            for me and that it was a waste of my time. Despite this, I have
            continued to pursue my interests and develop my skills through
            self-directed learning, online courses, and practical experience. I
            recognize the value of education and am constantly seeking
            opportunities to expand my knowledge and expertise in my chosen
            field. Through my experiences, I have learned the importance of
            finding a learning approach that works for me and am committed to
            ongoing personal and professional growth.
          </p>
        </div>
        <div className="absolute -bottom-[1100%] translate-y-[100%] left-[60%] -translate-x-1/2 w-96 p-5 border border-white rounded-lg">
          <div className="absolute left-1/2 -translate-x-1/2 top-0 -translate-y-full w-0 h-0 border-l-[20px] border-l-transparent border-b-[20px] border-b-white border-r-[20px] border-r-transparent"></div>
          <p>
        ...
        <div className="absolute -bottom-[1100%] translate-y-[100%] left-[100%] -translate-x-1/2 w-96 p-5 border border-white rounded-lg">
          <div className="absolute left-1/2 -translate-x-1/2 top-0 -translate-y-full w-0 h-0 border-l-[20px] border-l-transparent border-b-[20px] border-b-white border-r-[20px] border-r-transparent"></div>
          <p>
